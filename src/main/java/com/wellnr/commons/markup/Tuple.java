...
public final class Tuple {
    ...
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> apply(
            T1 _1, T2 _2, T3 _3, T4 _4, T5 _5) {
        return Tuple5.apply(_1, _2, _3, _4, _5);
    }

    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> apply(
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9>
            Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> apply(
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
            Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> apply(
